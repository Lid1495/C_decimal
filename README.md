# Реализация статической библиотеки s21_decimal.a на языке Си

Проект Школы 21. Групповой проект.

Полное покрытие unit-тестами функций библиотеки c помощью библиотеки Check (покрывается не менее 80% каждой функции)

______________________________________________

Тип Decimal - десятичные числа в диапазоне от положительных 79,228,162,514,264,337,593,543,950,335 до отрицательных 79,228,162,514,264,337,593,543,950,335.
